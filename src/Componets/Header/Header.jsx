...
import imgs from "../../imgs/Rectangle 21.png"
import imgs2 from "../../imgs/watsapp (1).svg"
import imgs3 from "../../imgs/telegram.png"
import "../../css/Header.css"
const Header = () => {
  return (
<div className="Header">
  <div className="Header_img">
    <img src={imgs} alt="" className="Header_imgs"/>
  </div>
 <div className="1">
...
<div className="3">
  ...
  <div className="Header_Tels">
    <img src={imgs2} alt="" className="Header_imgs2"/>
    <img src={imgs3} alt="" className="Header_imgs3"/>
